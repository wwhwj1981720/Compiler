...
/**
 * @author Administrator  LLNatureFuntionTranslateJavaSentanceALl type id;  type id(v){L} qubie 
 *    Sjava程序语言的开始  java
 *   Z->DZ|PZ|ε  Z是语句块s
	 D 类定义 变量
 *   P 类函数
 ...
 *   
 */
public class LLNatureFuntionTranslateJavaSentanceALLVersion  {
