...
import com.LLNatureFuntionTranslateJavaSentanceALLVersion;
import com.LLWordListFunction;

import task.OneFileTask;
import unicom.WordUnit;

public class testNatureFunctionJavaSentanceAllVersion {
	...
	public static void main(String[] args) {
		...
		String path="javaSentenceall.txt";
		...
		LLNatureFuntionTranslateJavaSentanceALLVersion test=new LLNatureFuntionTranslateJavaSentanceALLVersion();
		test.init();
		test.initVector();
