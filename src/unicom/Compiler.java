                                ...
                                switch(state){
                                        case 0:
                                               ...
                                               //isDigit(int) - 类 java.lang.Character 中的静态方法  功能：确定指定字符（Unicode 代码点）是否为数字。
                                                ...
                                                else if(isRange(c))   state=17;//界限阜
                                        ...
                                        case 10://标志符是 字母
                                                if(isLetter(c) || isDigit(c)){
                                                        ...
                                                        if(isKey(id))
                                                        {
                                                            if(isFunctionKey(id))    error_text.appendText("info: 类型关键字 " + id + '\n');
                                                            else error_text.appendText("info: 关键字 " + id + '\n');
                                                        }
                                                        else
                                        ...
                                        //特殊符是 {
                                        case 17:
                                        	error_text.appendText("info: 界限符 "+content.charAt(i-1)+ "\n");
                                        	 i--;
