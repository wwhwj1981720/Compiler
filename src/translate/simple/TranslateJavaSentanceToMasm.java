 ...
 *   
 */
public class TranslateJavaSentanceToMasm  {
...
//		v[3][2].transatev.add(")");
//		v[3][2].transatev.add("@BF");
//		//v[3][2].transatev.add("{");
//		v[3][2].transatev.add("L");
//		v[3][2].transatev.add("@BL");
		//v[3][2].transatev.add("}");
		...
		v[3][2].stack.add("M");
		v[3][2].stack.add("J");
		v[3][2].transatev.add("M");
		v[3][2].transatev.add("J");
...
//		v[7][13].transatev.add("ε");
		//G->L 以前语句与语句块存在解释错误，去掉M，新加 G
				//G->LG
				v[7][0]=new Regular();
				v[7][0].stack.add("L");
				v[7][0].stack.add("G");
				v[7][0].transatev.add("L");
				v[7][0].transatev.add("G");
				//G->LG
				v[7][1]=new Regular();
				v[7][1].stack.add("L");
				v[7][1].stack.add("G");
				v[7][1].transatev.add("L");
				v[7][1].transatev.add("G");
		...
		v[17][14].stack.add("B");
		v[17][14].stack.add("U");
		v[17][14].transatev.add("B");
		v[17][14].transatev.add("U");
		//E->BU
		v[17][0]=new Regular();
		v[17][0].stack.add("B");
		v[17][0].stack.add("U");
...
//		v[8][13].stack.add("ε");
		...
		v[21][2].stack.add("while");
		v[21][2].stack.add("(");
		v[21][2].stack.add("E");
		v[21][2].stack.add(")");
		
		v[21][2].transatev.add("while");
		v[21][2].transatev.add("(");
		v[21][2].transatev.add("E");
		v[21][2].transatev.add(")");
		v[21][2].transatev.add("@BF");
		//J->L
		v[22][0]=new Regular();
		v[22][0].stack.add("L");
		v[22][0].transatev.add("L");
		v[22][0].transatev.add("@BL");
		//J->L
		v[22][1]=new Regular();
		v[22][1].stack.add("L");
		v[22][1].transatev.add("L");
		v[22][1].transatev.add("@BL");
		//J->L
		v[22][2]=new Regular();
		v[22][2].stack.add("L");
		v[22][2].transatev.add("L");
		v[22][2].transatev.add("@BL");
		//J->L
		v[22][10]=new Regular();
		v[22][10].stack.add("L");
		v[22][10].transatev.add("L");
		v[22][10].transatev.add("@BL");
		//J->L
		v[22][13]=new Regular();
		v[22][13].stack.add("L");
		v[22][13].transatev.add("L");
		v[22][13].transatev.add("@BL");
		//J->{G}
		v[22][12]=new Regular();
		v[22][12].stack.add("{");
		v[22][12].stack.add("G");
		v[22][12].stack.add("}");
		v[22][12].transatev.add("{");
		v[22][12].transatev.add("G");
		v[22][12].transatev.add("}");
		v[22][12].transatev.add("@BL");
			...
			else if((vt.containsKey(nowc)))
			{
				if((nowc.equals(ch.getNature()))&&(!ch.getNature().equals("#")))
				{
					...
					try {
						...
						//popnode.word.setValue(this.strque.peek().getValue());
						//popnode.word.setNature(this.strque.peek().getNature());
						popnode.setWord(this.strque.peek());
	...
	public void putStackReverse(Regular regular,String nowc)
	{
		...
		{
			blockrow++;
			stacktop.blockrow=this.blockrow;
		}
		System.out.println(nowc+"->"+regularstr.toString());
		grammarTranslate(nowc,stacktop);
	}
	/*
	 * 非终结符的语法翻译
	 * 
	 * **/
	public void grammarTranslate(String vt,MutiNode regularleft)
	{
		if(vt.equals("I"))//局部变量定义语句
		{
			GrammarTransInterface iregular=new GrammarTranslateI();
		}
