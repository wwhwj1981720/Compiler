...
public class testTranslateJavaSentanceToMasm {
	...
	public static void main(String[] args) {
		...
		TranslateJavaSentanceToMasm test=new TranslateJavaSentanceToMasm();
		test.init();
		test.initVector();
...
//				}
				if(node.data.equals("L"))//是否是函数
				{
					System.out.print(node.blockrow);
